    ...
    while True:
        ...
        if eth_protocol == 8:
            ...
            if proto == 1:
                ...
                print(TAB_2 + 'Data: ')
                print(format(format_multi_line(DATA_TAB_3, data)))

            elif proto == 6:
                (src_port, dest_port, sequence, acknowledgement, flag_urg, flag_ack, flag_psh,
                 flag_rst, flag_syn, flag_fin) = tcp_packet(data)
...
def tcp_packet(data):
    ...
    return (src_port, dest_port, sequence, acknowledgement, flag_urg, flag_ack, flag_psh,
